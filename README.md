...
This regenerates `data/diagram/pose-analysis-normalized.csv`, appends normalized values to `data/diagram/index.csv`, recreates the three display assets for every complete pose, and writes `public/data/embedding.json`.
